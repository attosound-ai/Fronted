...
export function StepCreatorPassword({
  ...
  const bothFilled =
    state.creatorPassword.length > 0 && state.creatorConfirmPassword.length > 0;
  const passwordsMatch = state.creatorPassword === state.creatorConfirmPassword;
  const canContinue =
    isStrongPassword(state.creatorPassword) && bothFilled && passwordsMatch;
  ...
  return (
    ...
    >
      <Text variant="body" style={styles.subtitle}>
        {t('creatorAccountSetup.passwordSubtitle')}
      </Text>
      ...
      <View style={styles.formArea}>
        ...
        */}
        ...
        <View>
          ...
          {bothFilled && !passwordsMatch && (
            <Text variant="small" style={styles.matchError}>
              {tv('passwordMismatch')}
            </Text>
          )}
        </View>
