...
export const ANALYTICS_EVENTS = {
  ...
  MESSAGES: {
    ...
    SHARED_POST_PLAYED: 'messages_shared_post_played',
    TYPING_RECEIVED: 'messages_typing_received',
    MESSAGE_PINNED: 'messages_message_pinned',
    MESSAGE_UNPINNED: 'messages_message_unpinned',
    MESSAGE_PIN_FAILED: 'messages_message_pin_failed',
    PINNED_BAR_TAPPED: 'messages_pinned_bar_tapped',
    PINNED_REALTIME: 'messages_pinned_realtime',
    CAMERA_CAPTURE: 'messages_camera_capture',
